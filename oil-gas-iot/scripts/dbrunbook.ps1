  workflow db_schema{
    ...
    start-Sleep -s 40
    sqlcmd.exe -ServerInstance $AzureSQLServerName -Database "master" -Username "sqladmin" -Password "Password@1234" -Query $ScriptFromGit.Content
    start-Sleep -s 40
    ...
    start-Sleep -s 20
    sqlcmd.exe -ServerInstance $AzureSQLServerName -Database "db4cards" -Username "sqladmin" -Password "Password@1234" -Query $ScriptFromGit2.Content 
    }
}
