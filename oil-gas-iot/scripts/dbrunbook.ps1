workflow db_schema{
    ...
    start-Sleep -s 120
    Invoke-Sqlcmd -QueryTimeout 0 -ServerInstance $AzureSQLServerName -Database "db4cards" -Username "sqladmin" -Password "Password@1234" -Query $ScriptFromGit2.Content
    }
}
